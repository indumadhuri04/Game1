...
function draw() {
  ...
  fill('orange');
  textSize(24);
  text("PRESS SPACE TO GET A SECOND CHANCE TO PLAY And EAT A TURKEY", 200,200);
  text("OR IF YOU PREFER, LET THE TURKEY EAT YOU.",300,300);
